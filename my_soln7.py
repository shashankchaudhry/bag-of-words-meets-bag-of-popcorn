# -*- coding: utf-8 -*-
"""
Created on Sat Apr 25 18:06:46 2015
...
X_subset = X_first_set[(result < 0.20) | (result > 0.80)]
result = result[(result < 0.20) | (result > 0.80)]
...
output.to_csv('/Users/schaud7/Documents/personal_git/data/my_tenth_model_with_extract_overall_tfidf_super_learn_loose_thresh.csv', index=False, quoting=3)
